...
(function ($, window, document) {
	...
	******************************************************************************/
	var defaults = {
		...
		on_INIT_DONE: '',                           //To Call external function when init is complete (JOSHP)
	...
	function Zoomer($elem, params) {
		...
		**********************************************************/
		...
		this.onINITDONE = op.on_INIT_DONE; // JOSHP
	...
	var supportsTouch = false; // Modernizr.touch;
	// TODO: Hack for firefox/chrome. Find permanent fix
